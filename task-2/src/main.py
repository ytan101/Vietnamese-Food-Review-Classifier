...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, help="train: enables training loop, infer: predicts your input sentiment", default="train")
    parser.add_argument("--model_path", type=str, help="model path, models located in ./data/raw", default="../data/models/model_2023-01-15_01-15-00.pt")
    ...
    # Modelling
    model = SentimentClassifier(dataset=reviews_dataset, mode=args.mode, batch_size=8, truncation_length=512, num_epochs=2,)
