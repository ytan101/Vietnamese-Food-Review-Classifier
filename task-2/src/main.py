...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, help="train: enables training loop, infer: predicts your input sentiment")
    ...
    # Modelling
    model = SentimentClassifier(dataset=reviews_dataset, batch_size=8, truncation_length=512, num_epochs=2)
    ...
    if args.mode == "infer":
        text_input = {"Review": ['''
                                ...
                                ''']}
        model.inference_loop("model.pt", text_input)
